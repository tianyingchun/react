...
const SubMenu = React.createClass({
  ...
  mixins: [ClassNameMixin, SubMenuStateMixin],
  ...
  renderChildren(children) {
    ...
    const baseProps = {
      ...
      classPrefix: props.classRootPrefix,
      id: this._menuId,
  ...
  render() {
    ...
    const prefixCls = this.prefixClass(props.mode);
    const classes = {
      [this.prefixClass('submenu')]:true,
      [this.getOpenClassName()]: this.props.open
    };
